...
public class activity_gameplay2 extends Data {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewGroup myLayout = findViewById(R.id.myLayout3);
        ...
        context = this;
        Intent intent = new Intent(this, activity_gameplay.class);

        GameField2 myGameField = new GameField2(context, xStartPoint, yStartPoint, cellWidth, cellHeight, myLayout, cells, intent, this, 2, false);
        myGameField.print();
    }
